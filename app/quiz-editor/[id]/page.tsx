...
function QuizEditorContent({ routeQuizId }: { routeQuizId: string }) {
    ...
    const filteredQuestions = questions.filter((q, index) => {
        ...
        const passageText =
            q.type === "reading" ? (q as ReadingQuestion).passage || "" : "";
            ...
            <div className="fixed top-0 left-0 right-0 z-40 bg-slate-950/90 backdrop-blur-md border-b border-white/5 shadow-xl lg:hidden pt-[env(safe-area-inset-top)]">
                <div className="max-w-7xl mx-auto px-4 py-2 flex items-center justify-between gap-2">
                    <span className="text-[10px] text-slate-300 truncate font-bold flex items-center gap-1.5 min-w-0">
                        ...
                        {isDirty && (
                            <span className="text-amber-400 font-mono text-[9px] bg-amber-500/10 px-1 py-0.5 rounded border border-amber-500/20 shrink-0">
                                •
                            </span>
                        )}
                    </span>
            ...
            <div className="max-w-7xl mx-auto px-4 py-8 pt-14 lg:pt-8 relative z-10">
                ...
                <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4 mb-6">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-white flex items-center gap-2">
                                ...
                                {isDirty && (
                                    <Badge
                                        variant="outline"
                                        className="text-[10px] text-amber-400 border-amber-500/20 bg-amber-500/5 py-0.5 px-2"
                                    >
                            ...
                            <p className="text-slate-400 text-xs mt-0.5 font-medium">
                                Quản lý tổng số {questions.length} câu hỏi biên
                                soạn.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2 items-center">
                        ...
                        <Button
                            variant="outline"
                            className="h-9 border-white/5 hover:bg-white/5 rounded-xl cursor-pointer text-xs"
                            asChild={false}
                        >
                            <a
                ...
                <Card className="mb-6 bg-slate-900/60 border-white/10 shadow-xl overflow-hidden backdrop-blur-xl rounded-3xl">
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-white">
                                    Cấu hình chung của Quiz
                                </h3>
                                <p className="text-xs text-slate-400 mt-0.5 font-medium">
                                    {metadata?.title || "Chưa đặt tên"} ·{" "}
                                    {metadata?.category || "Chưa có danh mục"} ·
                                    Thời gian mặc định: {defaultTime}s · Thời
                                    gian thi:{" "}
                                    {Math.max(
                                        1,
                                        Math.floor(
                                            (metadata?.examTimeLimit ?? 1800) /
                                                60
                                        )
                                    )}{" "}
                                    phút
                        ...
                        <Button
                            variant="ghost"
                            size="sm"
                            className="gap-1.5 shrink-0 text-slate-400 hover:text-white cursor-pointer rounded-lg"
                            type="button"
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2 border-t border-white/[0.04]">
                                <div className="flex flex-wrap items-center gap-3">
                                    <div className="flex flex-col gap-1">
                                        <Label className="text-slate-400 text-xs font-bold uppercase tracking-wider">
                                            Thời gian mặc định câu hỏi
                                        </Label>
                                        <p className="text-[10px] text-slate-500">
                                            Giây khả dụng cho mỗi câu hỏi
                                        </p>
                                    </div>
                                ...
                                <div className="flex flex-wrap items-center gap-3">
                                    <div className="flex flex-col gap-1">
                                        <Label className="text-slate-400 text-xs font-bold uppercase tracking-wider">
                                            Thời gian làm bài thi thử (Exam)
                                        </Label>
                                        <p className="text-[10px] text-slate-500 font-medium">
                                            Quy đổi phút hiển thị tại /do-exam
                                        </p>
                                    </div>
                                    <Input
                                        type="number"
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center justify-between gap-2 mb-1.5">
                                            ...
                                            <Badge
                                                variant="outline"
                                                className="text-[9px] px-1.5 py-0 bg-slate-950/60 text-slate-400 border-white/5 uppercase"
                                            >
                ...
                >
                    ...
                    <div className="relative bg-slate-900 border border-white/10 rounded-3xl p-6 max-w-sm w-full shadow-2xl animate-in zoom-in-95 duration-200">
                        ...
                        <p className="text-slate-400 text-xs leading-relaxed mb-5 font-medium">
                            Bạn có chắc chắn muốn xóa vĩnh viễn câu hỏi này khỏi
                            bài Quiz? Hành động này có thể hoàn tác qua nút bấm
                            `Ctrl + Z`.
                        </p>
                    ...
                    <div className="relative bg-slate-900 border border-white/10 rounded-3xl p-6 max-w-md w-full shadow-2xl animate-in zoom-in-95 duration-200">
                        ...
                        <div className="space-y-3.5 mb-6">
                            <div className="flex justify-between items-center text-xs">
                                ...
                                <span className="font-mono bg-slate-950 border border-white/5 px-2 py-1 rounded text-indigo-300 font-bold">
                                    Ctrl + S
                                </span>
                            </div>
                            <div className="flex justify-between items-center text-xs">
