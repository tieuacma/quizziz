  ...
  return (
    <div className="zenith-immersive min-h-screen flex items-center justify-center px-4">
      ...
      <div className="relative z-10 max-w-md w-full zenith-card p-8 text-center">
        ...
        <Button asChild size="lg" className="zenith-btn-glow w-full rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 border-0">
          <Link href="/quiz-game" className="flex items-center justify-center gap-2">
