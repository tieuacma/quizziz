...
export type SerializedMongoDoc<T> = { [K in keyof T]: unknown } & { id?: string }

export function serializeMongoDoc<T extends Record<string, unknown>>(doc: T): SerializedMongoDoc<T> {
