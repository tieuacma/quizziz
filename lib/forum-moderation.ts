...
const BANNED_KEYWORDS = [
  'cờ bạc', 'cá độ', 'đá gà', 'hack game', 'tải hack', 
  'web sex', 'phim người lớn', 'lừa đảo', 'hack points', 
  'hack điểm', 'mua điểm', 'bán đề', 'lộ đề thi'
];

// Danh sách từ khóa nghi vấn (Chuyển sang trạng thái Pending - Chờ duyệt)
const SENSITIVE_KEYWORDS = [
  'chửi', 'ngu', 'dốt', 'gian lận', 'phao thi', 
  'quay cóp', 'admin ơi', 'giáo viên ơi', 'đáp án thi',
  'tiết lộ', 'spammer', 'quảng cáo'
];
 ...
 */
export function runAutoModeration(title: string, text: string): ModerationResult {
  ...
  if (words.length > 0 && uniqueWords.size / words.length < 0.4 && words.length > 10) {
    return {
      status: 'pending',
      score: 0.55,
