            ...
            <div className="px-6 py-5 border-b border-white/8 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-violet-500 via-purple-600 to-fuchsia-600 flex items-center justify-center shadow-lg shadow-violet-600/40 ring-1 ring-white/20 relative overflow-hidden group">
                        ...
                        <span className="text-base font-black text-white relative z-10">
                            Z
                        </span>
                    </div>
                    {!isCollapsed && (
            ...
            <div className="px-4 py-4 border-b border-white/8 transition-all duration-300">
                ...
                >
                    ...
                    {!isCollapsed && (
                        ...
                        >
                            <p className="text-white text-sm font-semibold truncate leading-4">
                                {user.name}
                            </p>
                        ...
                        >
                            ...
                            >
                                ...
                                {!isCollapsed && (
                                    ...
                                    >
                                        <span className="text-sm font-semibold tracking-wide leading-4">
                                            {item.label}
                                        </span>
                                        <span className="text-[10px] text-slate-500 leading-3">
                                            {item.vietnamese}
                                        </span>
                                    </motion.div>
                                )}
    ...
    const menuItems =
        user.role === "teacher"
            ? [
                  ...
                  {
                      label: "Quizzes",
                      vietnamese: "Trắc nghiệm",
                      href: `${teacherBase}/quizzies`,
                      icon: Puzzle,
                  },
                  {
                      label: "Students",
                      vietnamese: "Học sinh",
                      href: `${teacherBase}/students`,
                      icon: Users,
                  },
                  {
                      label: "Forum",
                      vietnamese: "Diễn đàn",
                      href: `${teacherBase}/forum`,
                      icon: MessageSquare,
                  },
                  {
                      label: "Analytics",
                      vietnamese: "Báo cáo",
                      href: `${teacherBase}/analytics`,
                      icon: TrendingUp,
                  },
                  {
                      label: "Settings",
                      vietnamese: "Cài đặt",
                      href: `${teacherBase}/settings`,
                      icon: Settings,
                  },
              ]
            : [
                ...
                <header className="h-16 border-b border-white/10 zenith-glass flex items-center justify-between px-4 md:px-6 sticky top-0 z-30 gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            ...
                            <SheetContent
                                side="left"
                                className="w-64 bg-[#07060f] border-white/8 p-0"
                            >
                                            ...
                                            {notifications.map((n) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="min-w-0">
                                                        ...
                                                        <p className="text-[11px] text-slate-400 leading-4 mt-0.5 truncate">
                                                            {n.desc}
                                                        </p>
