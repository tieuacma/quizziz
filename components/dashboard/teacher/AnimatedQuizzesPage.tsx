...
export default function AnimatedQuizzesPage({
  ...
  const [sortBy, setSortBy] = useState<"date" | "submissions" | "avg">("date");
  const [viewMode, setViewMode] = useState<"grid" | "list">("grid");
  const [selectedQuizzes, setSelectedQuizzes] = useState<Set<string | number>>(
    new Set(),
  );
      ...
      <section>
          ...
          <div className="flex flex-wrap gap-3 items-center">
            ...
            <Select value={sortBy} onValueChange={(v) => setSortBy(v as any)}>
              ...
              <SelectContent>
                ...
                <SelectItem value="submissions">Tỷ lệ nộp</SelectItem>
        ...
        {filteredQuizzes.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-white/10 bg-white/[0.02] px-6 py-16 text-center">
            ...
            <p className="text-white font-medium">Không tìm thấy quiz nào</p>
            ...
            {filteredQuizzes.map((q, i) => {
              ...
              return (
                <div key={q.id} className="relative">
                  ...
                  <div
                    className={
                      isSelected ? "ring-2 ring-violet-500/50 rounded-xl" : ""
                    }
                  >
                    <AnimatedQuizCard q={q} status={status} index={i} />
                  </div>
                </div>
              );
            })}
