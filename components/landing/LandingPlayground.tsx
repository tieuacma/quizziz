                ...
                <div className="lg:col-span-5 flex flex-col gap-6 text-center lg:text-left">
                    ...
                    >
                        ...
                        <p className="text-slate-400 text-lg leading-relaxed mb-6">
                            Lớp học của bạn sẽ tràn đầy hứng khởi với giao diện
                            đấu bài câu hỏi cực kỳ sinh động. Chơi thử bản demo
                            3 câu bên cạnh để cảm nhận sự mượt mà!
                        </p>
                    </motion.div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4 max-w-md mx-auto lg:mx-0">
                        <div className="p-4 rounded-xl bg-white/[0.03] border border-white/5 flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-white mb-1">
                                    Mượt mà & Sync cực nhanh
                                </h3>
                                <p className="text-xs text-slate-400">
                                    Đồng bộ câu hỏi & đáp án dưới 50ms nhờ nền
                                    tảng WebSocket.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="p-4 rounded-xl bg-white/[0.03] border border-white/5 flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-white mb-1">
                                    Hiệu ứng Streak & Neon
                                </h3>
                                <p className="text-xs text-slate-400">
                                    Kích thích động lực học tập thông qua điểm
                                    số và chuỗi trả lời đúng.
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                {step === "intro" && (
                                    ...
                                    >
                                        ...
                                        <h3 className="text-2xl font-black text-white mb-2 tracking-tight">
                                            ZENITH LIVE PLAYGROUND
                                        </h3>
                                        <p className="text-sm text-slate-400 max-w-sm mb-8 leading-relaxed">
                                            Sẵn sàng làm bài kiểm tra nhanh 3
                                            câu hỏi để so tài cùng các thầy cô
                                            và bạn bè trên hệ thống?
                                        </p>
                                        <Button
                                        ...
                                        <div className="mb-6">
                                            ...
                                            <div className="h-2 rounded-full bg-white/5 overflow-hidden">
                                                <div
                                                    ...
                                                    style={{
                                                        width: `${((currentIdx + 1) / PLAYGROUND_QUESTIONS.length) * 100}%`,
                                                    }}
                                                />
                                            </div>
                                        </div>
                                                ...
                                                (opt, oIdx) => {
                                                    ...
                                                    if (isAnswered) {
                                                        if (
                                                            ...
                                                            btnStyle =
                                                                "neon-border-emerald bg-emerald-500/15 text-emerald-300 border-emerald-500/50";
                                                        } else if (
                                                            selectedOpt === oIdx
                                                        ) {
                                                            btnStyle =
                                                                "neon-border-rose bg-rose-500/15 text-rose-300 border-rose-500/50";
                                                        } else {
                                                            btnStyle =
                                                    ...
                                                    (player, index) => (
                                                        ...
                                                        >
                                                            <div className="flex items-center gap-3.5">
                                                                <span
                                                                    className={`text-sm font-black w-5 text-center ${index === 0 ? "text-yellow-400" : index === 1 ? "text-slate-300" : "text-slate-500"}`}
                                                                >
                                                                    #{index + 1}
                                                                </span>
