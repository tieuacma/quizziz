...
export const FAQ_ITEMS = [
  ...
  {
    question: "Giáo viên có thể xem kết quả & đánh giá sau mỗi phiên quiz không?",
    answer:
      "Có. Sau khi kết thúc phiên, giáo viên có thể xem thống kê theo lớp, từng câu hỏi và mức độ hoàn thành để hỗ trợ đánh giá nhanh.",
  },
  {
    question: "Tôi có thể tạo nhiều lớp học cùng lúc không?",
    answer:
      "Được. Tùy gói tài khoản, bạn có thể tạo và quản lý nhiều lớp học, mời học sinh tham gia và tổ chức quiz theo lịch.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Có. Gói Pro và School cho phép xuất báo cáo chi tiết ra Excel và PDF, bao gồm thống kê theo lớp, từng học sinh và từng câu hỏi.",
  },
  {
    question: "AI Smart Generator hoạt động như thế nào?",
    answer:
      "Bạn chỉ cần tải lên tài liệu (slide, giáo án, văn bản). AI sẽ phân tích nội dung và tự động tạo bộ câu hỏi trắc nghiệm phù hợp, tiết kiệm đến 80% thời gian soạn bài.",
  },
  {
    question: "Học sinh có thể tham gia quiz từ nhà không?",
    answer:
      "Có. Học sinh chỉ cần mã phiên do giáo viên cung cấp để tham gia quiz từ bất kỳ đâu, trên bất kỳ thiết bị nào có kết nối internet.",
  },
  {
    question: "Có hỗ trợ tích hợp với hệ thống trường học không?",
    answer:
      "Gói School hỗ trợ tích hợp SSO/LDAP, cho phép đồng bộ tài khoản với hệ thống hiện có của trường. Liên hệ support@zenith.edu để được tư vấn.",
  },
  {
    question: "Dữ liệu học tập được lưu trữ bao lâu?",
    answer:
      "Gói Free lưu trữ 30 ngày. Gói Pro lưu trữ không giới hạn. Gói School có thể tùy chỉnh theo yêu cầu và cam kết bảo mật theo tiêu chuẩn giáo dục.",
  },
  {
    question: "Có chế độ offline cho quiz không?",
    answer:
      "Hiện tại quiz yêu cầu kết nối internet để đồng bộ real-time. Tuy nhiên, giáo viên có thể xuất đề thi dạng PDF để in và sử dụng offline khi cần.",
  },
] as const;
...
export const PLAYGROUND_QUESTIONS = [
  {
    question: "Zenith EDU sử dụng công nghệ nào để đồng bộ kết quả quiz thời gian thực?",
    options: ["Rest API truyền thống", "WebSocket / Real-time Sync", "Gửi email báo cáo", "Lưu local storage"],
    correctIndex: 1,
    explanation: "Zenith sử dụng WebSocket/Real-time Engine giúp đồng bộ điểm số và hiệu ứng giữa Giáo viên và Học sinh dưới 50ms!",
  },
  {
    question: "Tính năng nổi bật giúp giáo viên tiết kiệm 80% thời gian soạn bài kiểm tra là gì?",
    options: ["Nhập tay từng câu", "AI Smart Generator (Tự động tạo quiz)", "Copy từ sách giáo khoa", "Chụp ảnh đề thi"],
    correctIndex: 1,
    explanation: "AI Smart Generator tích hợp sẵn giúp tự động phân tích tài liệu và tạo câu hỏi trắc nghiệm đa dạng trong vài giây.",
  },
  {
    question: "Giao diện quiz-game của Zenith hỗ trợ các loại câu hỏi nào?",
    options: ["Chỉ trắc nghiệm đơn", "Trắc nghiệm, Đúng/Sai & Điền vào chỗ trống", "Chỉ điền vào chỗ trống", "Tự luận dài"],
    correctIndex: 1,
    explanation: "Zenith hỗ trợ bộ câu hỏi tương tác phong phú gồm Trắc nghiệm (Multi-choice), Đúng/Sai (True/False) và Điền khuyết (Fill Blank).",
  },
] as const;
...
export const PRICING_PLANS = [
  {
    ...
    priceMonthly: 0,
    priceAnnually: 0,
    description: "Trải nghiệm đầy đủ các tính năng cốt lõi cho lớp học nhỏ.",
    features: [
