        ...
        >
            ...
            <div className="relative text-center mb-12 sm:mb-16">
                ...
                >
                    ...
                    <p className="text-slate-400 max-w-2xl mx-auto text-lg">
                        Dù bạn là giáo viên hay học sinh, Zenith EDU được thiết
                        kế để đáp ứng nhu cầu riêng của bạn.
                    </p>
                </motion.div>
            </div>
            ...
            <AnimatePresence mode="wait">
                <motion.div
                    key={active}
                    initial={
                        reduced ? false : { opacity: 0, y: 20, scale: 0.98 }
                    }
