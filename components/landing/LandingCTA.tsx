    ...
    <section className="relative max-w-7xl mx-auto px-4 sm:px-6 py-20 sm:py-32 overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            Sẵn sàng nâng tầm{" "}
            <span className="zenith-gradient-text">trải nghiệm?</span>
          </motion.h2>
          ...
          >
            Tham gia cùng hàng nghìn giáo viên và học sinh đang sử dụng Zenith EDU để quản lý khóa học, tạo quiz tương tác, và theo dõi tiến độ học tập mỗi ngày.
          </motion.p>
