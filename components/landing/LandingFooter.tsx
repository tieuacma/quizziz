    ...
    <footer className="relative border-t border-white/10 bg-gradient-to-b from-[#030208] to-[#010105]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20 lg:py-24">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12 lg:mb-16">
          ...
          >
            <h3 className="text-sm font-semibold text-white mb-5 uppercase tracking-wider">Sản phẩm</h3>
          ...
          >
            <h3 className="text-sm font-semibold text-white mb-5 uppercase tracking-wider">Tài khoản</h3>
            <ul className="space-y-3">
