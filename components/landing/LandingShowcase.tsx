    ...
    <div className="h-full min-h-[280px] p-6 flex flex-col gap-4">
      ...
      <div className="grid grid-cols-3 gap-3 flex-1">
        {["K22A", "K22B", "K21"].map((c) => (
          ...
          >
            <p className="text-[11px] text-violet-300 font-semibold mb-1">{c}</p>
            <p className="text-sm text-white font-bold">38</p>
            <p className="text-[10px] text-slate-400 mt-1">học sinh</p>
          </motion.div>
        ))}
      </div>
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[11px] text-slate-300">Điểm TB: 7.8 • ↑ 0.5 tuần này</p>
        </div>
      </motion.div>
    </div>
  );
...
function QuizPanel() {
  const options = [
    { label: "GET", color: "bg-emerald-500/25 border-emerald-500/50 text-emerald-300" },
    { label: "POST", color: "bg-violet-500/25 border-violet-500/50 text-violet-300" },
    { label: "PUT", color: "bg-amber-500/25 border-amber-500/50 text-amber-300" },
    { label: "DELETE", color: "bg-rose-500/25 border-rose-500/50 text-rose-300" },
  ];
  ...
  return (
    <div className="h-full min-h-[280px] p-6 flex flex-col">
      ...
      <div className="flex justify-between items-center mb-4">
        <span className="text-sm font-semibold text-white">Câu 3 / 10</span>
        <div className="flex items-center gap-2">
          <span className="text-lg">🔥</span>
          <span className="text-sm font-bold text-orange-400">5 × streak</span>
        </div>
      </div>
      ...
      <div className="mb-5 p-3 rounded-xl bg-gradient-to-r from-violet-600/20 to-purple-600/10 border border-violet-500/30">
        ...
        <p className="text-2xl font-black text-white">1,240 <span className="text-lg text-slate-400">pts</span></p>
      </div>
      ...
      <div className="relative text-center mb-16 sm:mb-20">
        ...
        >
          ...
          <p className="text-slate-400 max-w-2xl mx-auto text-lg">
            Dashboard quản lý lớp học và quiz game tương tác — thiết kế đẹp mắt, dễ sử dụng, tối ưu cho mọi thiết bị.
          </p>
        </motion.div>
      </div>
      ...
      >
        ...
        >
          ...
          <div className="px-6 py-5 border-b border-white/10 bg-gradient-to-r from-white/[0.03] to-transparent group-hover:from-white/[0.08] transition-all">
            ...
            <p className="text-sm text-slate-400">Quản lý lớp • Analytics • Lịch biểu</p>
          </div>
        ...
        >
          ...
          <div className="px-6 py-5 border-b border-white/10 bg-gradient-to-r from-white/[0.03] to-transparent group-hover:from-white/[0.08] transition-all">
            ...
            <p className="text-sm text-slate-400">Tương tác • Điểm số • Streaks</p>
          </div>
      ...
      >
        <div className="grid sm:grid-cols-3 gap-8">
          <div className="text-center sm:text-left">
            ...
            <p className="font-semibold text-white mb-1">Siêu nhanh</p>
            <p className="text-sm text-slate-400">Tải trong milliseconds, hoạt động mượt mà</p>
          </div>
          <div className="text-center">
            <p className="text-3xl mb-2">🛡️</p>
            <p className="font-semibold text-white mb-1">An toàn</p>
            <p className="text-sm text-slate-400">Mã hóa end-to-end, tuân thủ GDPR</p>
          </div>
          <div className="text-center sm:text-right">
            <p className="text-3xl mb-2">📱</p>
            <p className="font-semibold text-white mb-1">Responsive</p>
            <p className="text-sm text-slate-400">Hoàn hảo trên desktop, tablet, mobile</p>
          </div>
        </div>
      </motion.div>
    </section>
