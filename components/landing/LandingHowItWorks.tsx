            ...
            <div className="relative text-center mb-16 sm:mb-20">
                ...
                >
                    ...
                    <p className="text-slate-400 max-w-2xl mx-auto text-lg">
                        Hành trình học tập của bạn chỉ cần ba bước để khởi động,
                        từ đăng ký đến tương tác đầu tiên.
                    </p>
                </motion.div>
            </div>
            ...
            >
                <div className="text-center">
                    <p className="text-slate-400 mb-6">
                        ⚡ Quản lý lớp học, tạo quiz, và xem kết quả ngay lập
                        tức — tất cả trong một nền tảng
                    </p>
