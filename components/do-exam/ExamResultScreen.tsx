    ...
    useGSAP(
        () => {
            ...
            const rows = Array.from(
                resultRef.current.querySelectorAll("[data-result-row='1']")
            );
            ...
            >
                <Card className={`${styles.glassCard} overflow-hidden`}>
                    <CardHeader className="text-center pb-2">
                        ...
                        <h2 className="font-display text-2xl text-white font-bold mb-6">
                            Kết quả bài thi
                        </h2>
                        ...
                        <div className="relative mx-auto w-36 h-36 mb-4">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center">
                                ...
                                <span
                                    className={`text-xs font-bold uppercase tracking-wider mt-1 ${gradeTextClass}`}
                                >
                                    {grade.label}
                                </span>
                            </div>
                        ...
                        <div className="grid grid-cols-3 gap-3 max-w-sm mx-auto">
                            <div className="rounded-xl border border-emerald-500/25 bg-emerald-500/10 px-3 py-2">
                                <p className="text-[10px] text-emerald-300/70 uppercase font-bold">
                                    Đúng
                                </p>
                            ...
                            <div className="rounded-xl border border-rose-500/25 bg-rose-500/10 px-3 py-2">
                                <p className="text-[10px] text-rose-300/70 uppercase font-bold">
                                    Sai
                                </p>
                            ...
                            <div className="rounded-xl border border-violet-500/25 bg-violet-500/10 px-3 py-2">
                                <p className="text-[10px] text-violet-300/70 uppercase font-bold">
                                    Thời gian
                                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-2 pt-4">
                    ...
                    >
                        <Link href="/dashboard/teacher/quizzies">
                            Về danh sách Quiz
                        </Link>
                    </Button>
                </div>
