        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-white/[0.02] border border-white/10 p-5 rounded-3xl backdrop-blur-xl shadow-lg">
                <div className="flex flex-col justify-center">
                    <Label className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-1.5">
                        Loại câu hỏi
                    </Label>
                    <div className="flex items-center gap-2">
                        <Badge
                            variant="secondary"
                            className="px-3 py-1 bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 font-bold"
                        >
                            ...
                            (diff) => {
                                ...
                                return (
                                    <button
                                        ...
                                        type="button"
                                        onClick={() =>
                                            updateQuestion({ difficulty: diff })
                                        }
                                        className={cn(
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                    ...
                    <div className="lg:col-span-6 space-y-3.5 bg-slate-900/20 border border-white/10 p-5 rounded-3xl backdrop-blur-md shadow-lg">
                        <div className="flex justify-between items-center">
                            ...
                            <span className="text-[10px] font-bold text-slate-500 bg-slate-900 border border-white/10 px-2 py-0.5 rounded-md font-mono">
                                {
                                    (
                                        (question as ReadingQuestion).passage ||
                                        ""
                                    )
                                        .split(/\s+/)
                        ...
                        <Textarea
                            ...
                            onChange={(e) =>
                                updateQuestion({ passage: e.target.value })
                            }
                    ...
                    <div className="lg:col-span-6 space-y-3">
                        ...
                        <div className="space-y-4 max-h-[420px] overflow-y-auto pr-1.5 scrollbar-thin">
                            {(
                                (question as ReadingQuestion).questions || []
                            ).map((subQ, idx) => (
                                <div
                                    key={subQ.id}
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            <div>
                                                ...
                                                <Select
                                                    ...
                                                    onValueChange={(value) => {
                                                        const nextType =
                                                            value as ReadingSubQuestion["type"];
                                                        if (
                                                            nextType ===
                                                            "multiple-choice"
                                                        ) {
                            ...
                            {((question as ReadingQuestion).questions || [])
                                ...
                                <div className="py-8 text-center text-xs text-slate-500 border border-dashed border-white/5 rounded-2xl bg-white/[0.01]">
                                    Chưa có câu hỏi phụ nào. Nhấn nút bên dưới
                                    để thêm mới.
                                </div>
                            )}
                        </div>
                            ...
                            <CardContent className="pt-5 space-y-4">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-[10px] text-slate-500 italic">
                                        Mỗi hàng là một đáp án đúng thay thế
                                    </span>
                                </div>
                                <div className="space-y-2">
                                    {(
