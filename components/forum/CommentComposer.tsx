      ...
      <div className="space-y-3">
        <label className="block">
          <textarea
            ...
            placeholder={parentCommentId ? "Nhập câu trả lời chi tiết của bạn (dùng $...$ cho công thức)..." : "Nhập câu bình luận/thảo luận của bạn..."}
          />
        </label>
        ...
        {hasMath && content.trim().length > 0 && (
          <div className="bg-white/[0.01] border border-white/5 rounded-xl p-2.5">
            <div className="text-[9px] text-slate-400 font-bold uppercase tracking-wider mb-1">Xem trước công thức:</div>
