...
function SubQuestionInput({
                    ...
                    return (
                        <motion.button
                            ...
                            className={cn(
                                ...
                                isWrong &&
                                    "neon-border-rose bg-rose-500/20 shadow-[0_0_20px_rgba(244,63,94,0.3)] card-shake"
                            )}
                        >
                            {option.text}
                        </motion.button>
        ...
        return (
            <div className="grid grid-cols-2 gap-3" role="group">
                {options.map(({ value, label }) => {
                    ...
                    const isCorrect =
                        answered && String(sub.correctAnswer) === value;
                    const isWrong = answered && isSelected && !isCorrect;
    ...
    return <p className="text-slate-400">{quizGameCopy.reading.noOptions}</p>;
}
